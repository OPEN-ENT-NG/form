            ...
            <div class="question-title" guard-root>
                <div class="twelve" ng-if="vm.question.question_type == vm.types.FREETEXT">
                    <div ng-if="!vm.question.selected">
                        <h4 ng-if="vm.question.title" input-guard>[[vm.question.title]]</h4>
                        <h4 ng-if="!vm.question.title" class="empty" input-guard><i18n>formulaire.question.title.free.empty</i18n></h4>
                    </div>
                    <div ng-if="vm.question.selected">
