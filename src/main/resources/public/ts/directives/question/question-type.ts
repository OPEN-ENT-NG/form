    ...
    return {
        ...
        template: `
            <div class="question-type focusable">
                ...
                <question-type-singleanswer question="vm.question" has-form-responses="vm.hasFormResponses" form-elements="vm.formElements" ng-if="vm.question.question_type == vm.types.SINGLEANSWER" guard-root="formTitle"></question-type-singleanswer>
                <question-type-multipleanswer question="vm.question" has-form-responses="vm.hasFormResponses" ng-if="vm.question.question_type == vm.types.MULTIPLEANSWER" guard-root="formTitle"></question-type-multipleanswer>
                ...
                <question-type-singleanswer-radio question="vm.question" has-form-responses="vm.hasFormResponses" form-elements="vm.formElements" ng-if="vm.question.question_type == vm.types.SINGLEANSWERRADIO" guard-root="formTitle"></question-type-singleanswer-radio>
            </div>
        `,
