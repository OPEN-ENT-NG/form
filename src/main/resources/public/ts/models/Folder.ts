...
export class Folders extends Selection<Folder> {
    ...
    setDefaultFolders = () : void => {
        this.myFormsFolder = new Folder(0, idiom.translate("formulaire.forms.mine"));
        this.sharedFormsFolder = new Folder(1, idiom.translate("formulaire.forms.shared"));
        this.archivedFormsFolder = new Folder(2, idiom.translate("formulaire.forms.archived"));
