  ...
  endpoints: (builder) => ({
    getForms: builder.query<IForm[], void>({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        try {
          ...
          toast.error(t("formulaire.error.formService.list", { ns: FORMULAIRE_PUBLIC }));
        }
      },
    }),
    ...
    createForm: builder.mutation<IForm, IFormPayload>({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        try {
          await queryFulfilled;
          toast.success(t("formulaire.success.form.create", { ns: FORMULAIRE_PUBLIC }));
        } catch (err) {
          console.error("formulaire.error.formService.create", err);
          toast.error(t("formulaire.error.formService.create", { ns: FORMULAIRE_PUBLIC }));
        }
      },
    }),
    ...
    updateForm: builder.mutation<IForm, { payload: IFormPayload; formId: string; hasToastDisplay?: boolean }>({
      ...
      async onQueryStarted({ hasToastDisplay = true }, { queryFulfilled }) {
        try {
          await queryFulfilled;
          if (hasToastDisplay) toast.success(t("formulaire.success.form.save", { ns: FORMULAIRE_PUBLIC }));
        } catch (err) {
          console.error("formulaire.error.formService.update", err);
          toast.error(t("formulaire.error.formService.update", { ns: FORMULAIRE_PUBLIC }));
        }
      },
    }),
    ...
    deleteForm: builder.mutation<void, number>({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        try {
          ...
          toast.error(t("formulaire.error.formService.delete", { ns: FORMULAIRE_PUBLIC }));
        }
      },
    }),
    ...
    duplicateForms: builder.mutation<IForm[], IDuplicateFormPayload>({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        try {
          await queryFulfilled;
          toast.success(t("formulaire.success.forms.duplicate", { ns: FORMULAIRE_PUBLIC }));
        } catch (err) {
          console.error("formulaire.error.formService.duplicate", err);
          toast.error(t("formulaire.error.formService.duplicate", { ns: FORMULAIRE_PUBLIC }));
        }
      },
    }),
    ...
    moveForms: builder.mutation<IForm[], { formIds: number[]; destinationFolderId: number }>({
      ...
      async onQueryStarted(params, { queryFulfilled }) {
        try {
          ...
          toast.error(t("formulaire.error.formService.move", { ns: FORMULAIRE_PUBLIC }));
        }
      },
    }),
    ...
    restoreForms: builder.mutation<IForm[], number[]>({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        try {
          await queryFulfilled;
          toast.success(t("formulaire.success.forms.restore", { ns: FORMULAIRE_PUBLIC }));
        } catch (err) {
          console.error("formulaire.error.formService.restore", err);
          toast.error(t("formulaire.error.formService.restore", { ns: FORMULAIRE_PUBLIC }));
        }
      },
    }),
    exportPdfForm: builder.query<Blob, IForm[]>({
      ...
      async onQueryStarted(forms, { queryFulfilled }) {
        try {
          ...
          toast.error(t("formulaire.error.formService.export", { ns: FORMULAIRE_PUBLIC }));
        }
      },
    }),
    ...
    getUserFormsRights: builder.query<IFormRight[], void>({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        try {
          ...
          toast.error(t("formulaire.error.formService.rights", { ns: FORMULAIRE_PUBLIC }));
        }
      },
    }),
    sendReminder: builder.mutation<void, IFormReminderPayload>({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        try {
          await queryFulfilled;
          toast.success(t("formulaire.success.reminder.send", { ns: FORMULAIRE_PUBLIC }));
        } catch (err) {
