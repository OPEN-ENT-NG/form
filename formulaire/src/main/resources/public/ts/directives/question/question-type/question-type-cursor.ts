...
class Controller implements IViewModel {
    ...
    $onInit = async () : Promise<void> => {
        this.question.cursor_min_val = Constants.DEFAULT_CURSOR_MIN_VALUE;
        this.question.cursor_max_val = Constants.DEFAULT_CURSOR_MAX_VALUE;
        this.question.cursor_step = Constants.DEFAULT_CURSOR_STEP;
    }
