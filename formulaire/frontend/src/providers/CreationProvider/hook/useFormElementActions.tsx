...
export const useFormElementActions = (
  ...
  async function handleNestedQuestionDeletion(question: IQuestion) {
  ...
  async function handleTopLevelDeletion(toRemove: IFormElement) {
  ...
  function clearNextReferences(removedElement: IFormElement): (el: IFormElement) => IFormElement {
