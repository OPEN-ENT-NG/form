...
public class Fields {
    ...
    public static final String DATE_HOUR = "is_date_hour";
    ...
    public static final String LONG_ANSWER = "is_long_answer";
    public static final String MESSAGE = "message";
    public static final String METADATA = "metadata";
    public static final String MULTIPLE_CHOICE = "is_multiple_choice";
    ...
    public static final String RADIO_BTN = "is_radio_btn";
    ...
    public static final String SHORT_ANSWER = "is_short_answer";
    ...
    public static final String TYPE_FREETEXT = "is_type_freetext";
