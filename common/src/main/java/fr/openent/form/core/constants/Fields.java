...
public class Fields {
    ...
    public static final String FORM_ELEMENT_POSITION = "form_element_position";
    ...
    public static final String IS_MATRICE = "is_matrice";
    ...
    public static final String CUSTOM_PLACEHOLDER = "custom_placeholder";
