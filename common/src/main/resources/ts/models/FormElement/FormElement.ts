...
export abstract class FormElement implements Selectable {
    ...
    toJson() : Object {
        return {
            ...
            form_element_types: this.form_element_types,
    ...
    isSection = () : boolean => {
        return this.form_element_types === FormElementType.SECTION;
    }

    isQuestion = () : boolean => {
        return this.form_element_types === FormElementType.QUESTION;
    }
}